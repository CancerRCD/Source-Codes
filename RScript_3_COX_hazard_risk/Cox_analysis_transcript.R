...
# Dataframe
genes <- import("big_table_contacetado_FxG_Transcript.xlsx")
...
perform_cox_analysis <- function(genes, measure) {
  ...
  for (gene in unique_genes) {
    ...
    # Extract p.value, Type, and cancer values
  ...
  # Merge genes and results data frames by Gene and cancer_types
...
export(genes_merged, "final_cox_results_Transcript.xlsx", row.names = FALSE)
