...
# Import data frames
signatures <- import("all_signature.tsv")
main_concatened <- import("big_table_contacetado_signatures.tsv")
...
signatures$signature <- sapply(signatures$signature, process_gene_name)
...
export(filtered_main_concatened, "all_signature_expresson_filtred.tsv")
